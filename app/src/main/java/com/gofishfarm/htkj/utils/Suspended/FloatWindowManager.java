...
import static com.gofishfarm.htkj.utils.ActivityUtils.startActivity;
...
public class FloatWindowManager {
    ...
    public void applyOrShowFloatWindow(Context context) {
        //判断是否开启权限，因Android系统差异化验证，不对全部机型适配
    ...
    private void showConfirmDialog(Context context, String message, final OnConfirmResult result) {
        ...
        dialog = new AlertDialog.Builder(ActivityUtils.getTopActivity()).setCancelable(true).setTitle("")
                .setMessage(message)
