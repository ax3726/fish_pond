...
//                        Logger.i(TAG, "网络更改为 无网络  CURRENT_NETWORK_STATE =" + CURRENT_NETWORK_STATE);
                        break;
                    case 1:
                        setOnChangeInternet(true);//设置网络监听
//                        Logger.i(TAG, "网络更改为 WIFI网络  CURRENT_NETWORK_STATE=" + CURRENT_NETWORK_STATE);
                        break;
                    case 2:
                        setOnChangeInternet(true);//设置网络监听
//                        Logger.i(TAG, "网络更改为 移动网络  CURRENT_NETWORK_STATE =" + CURRENT_NETWORK_STATE);
                        break;
                    default:
                        break;
                }
