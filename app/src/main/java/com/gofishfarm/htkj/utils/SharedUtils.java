...
public class SharedUtils {
    ...
    private static SharedUtils prefsUtil;
    ...
    public SharedUtils putFloat(String key, float value) {
        editor.putFloat(key, value);
        editor.commit();
        return this;
    }

    public SharedUtils putLong(String key, long value) {
        editor.putLong(key, value);
        editor.commit();
        return this;
    }

    public SharedUtils putBoolean(String key, boolean value) {
    ...
    public SharedUtils putStringSet(String key, Set<String> value) {
