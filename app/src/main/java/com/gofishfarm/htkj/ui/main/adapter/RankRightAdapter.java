 ...
 * @Describtion ：
 */
public class RankRightAdapter extends BaseQuickAdapter<RankRightBean.InfoBean, BaseViewHolder> {

    public RankRightAdapter(int layoutResId, @Nullable List<RankRightBean.InfoBean> data) {
        super(layoutResId, data);
    }


    @Override
    protected void convert(BaseViewHolder helper, RankRightBean.InfoBean item) {
        ...
        helper.setText(R.id.tv_nick_name, item.getNick_name())
                .setText(R.id.tv_fast_most, item.getAve_fishing()+"条/h");
