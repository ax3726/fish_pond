 ...
 * @Describtion ：
 */
public class LeftTopAdapter extends BaseQuickAdapter<FollowListBean.FocusBean, BaseViewHolder> {

    public LeftTopAdapter(int layoutResId, @Nullable List<FollowListBean.FocusBean> data) {
