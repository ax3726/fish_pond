 ...
 * @Describtion ：
 */
public class LeftSearchAdapter extends BaseQuickAdapter<FollowListBean.FocusBean, BaseViewHolder> {

    public LeftSearchAdapter(int layoutResId, @Nullable List<FollowListBean.FocusBean> data) {
        super(R.layout.item_attention, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, FollowListBean.FocusBean item) {
