package com.gofishfarm.htkj.sweetAlert;
...
public class ProgressWheel extends View {
    ...
    /**
     * Set the properties of the paints WXModel're using to
    ...
    public void setProgress(float progress) {
        ...
        // If WXModel are currently in the right position
        // WXModel set again the last time animated so the
